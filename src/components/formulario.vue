...
export default {
  ...
  data() {
    return {
      ...
      formData: {
        pais: "", genero: "", primerNombre: "", segundoNombre: "", nacimiento: "",
        tipoDocumento: "", numeroDocumento: "", documentoFrente: null, documentoReverso: null,
        email: "", password: "", passwordConfirm: "", telefono: "", celular: "",
  ...
  <div class="p-10 bg-white shadow-md rounded-lg w-5/6 h-auto">
    ...
    <div v-if="step === 2">
      ...
      <div class="flex justify-between mt-4">
        <button @click="prevStep" class="bg-gray-700 hover:bg-gray-400 text-white px-4 py-2 rounded">
          Atrás
        </button>
        <button
          @click="nextStep"
